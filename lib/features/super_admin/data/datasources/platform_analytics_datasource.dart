...
class PlatformAnalyticsDatasource {
  ...
  Future<PlatformDashboardData> getDashboardData() async {
    final resp = await _client.dio.get('/api/v1/super-admin/dashboard');
  ...
  Future<PlatformAnalytics> getAnalytics({String period = 'last30'}) async {
    final resp = await _client.dio.get('/api/v1/super-admin/analytics', queryParameters: {'period': period});
